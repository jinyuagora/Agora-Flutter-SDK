...
class FakeIRtcEngineExInternal : public agora::rtc::IRtcEngineEx {
  ...
  virtual int queryInterface(agora::rtc::INTERFACE_ID_TYPE iid,
                             void **inter) override {
    return 0;
  }

  virtual char const *getVersion(int *build) override { return 0; }

  virtual char const *getErrorDescription(int code) override { return 0; }
  ...
  virtual int setSubscribeAudioBlacklist(agora::rtc::uid_t *uidList,
                                         int uidNumber) override {
    return 0;
  }

  virtual int setSubscribeAudioWhitelist(agora::rtc::uid_t *uidList,
                                         int uidNumber) override {
    return 0;
  }

  virtual int setSubscribeVideoBlacklist(agora::rtc::uid_t *uidList,
                                         int uidNumber) override {
    return 0;
  }

  virtual int setSubscribeVideoWhitelist(agora::rtc::uid_t *uidList,
                                         int uidNumber) override {
    return 0;
  }
  ...
  virtual int enableDualStreamMode(agora::rtc::VIDEO_SOURCE_TYPE sourceType,
                                   bool enabled) override {
    return 0;
  }

  virtual int enableDualStreamMode(
      agora::rtc::VIDEO_SOURCE_TYPE sourceType, bool enabled,
  ...
  virtual int
  setDualStreamMode(agora::rtc::VIDEO_SOURCE_TYPE sourceType,
                    agora::rtc::SIMULCAST_STREAM_MODE mode) override {
    return 0;
  }
  ...
  virtual int
  addInjectStreamUrl(char const *url,
                     agora::rtc::InjectStreamConfig const &config) override {
    return 0;
  }

  virtual int removeInjectStreamUrl(char const *url) override { return 0; }
  ...
  virtual int
  setAdvancedAudioOptions(agora::rtc::AdvancedAudioOptions &options) override {
    return 0;
  }
  ...
  virtual int setSubscribeAudioBlacklistEx(
      agora::rtc::uid_t *uidList, int uidNumber,
      agora::rtc::RtcConnection const &connection) override {
    return 0;
  }

  virtual int setSubscribeAudioWhitelistEx(
      agora::rtc::uid_t *uidList, int uidNumber,
      agora::rtc::RtcConnection const &connection) override {
    return 0;
  }

  virtual int setSubscribeVideoBlacklistEx(
      agora::rtc::uid_t *uidList, int uidNumber,
      agora::rtc::RtcConnection const &connection) override {
    return 0;
  }

  virtual int setSubscribeVideoWhitelistEx(
      agora::rtc::uid_t *uidList, int uidNumber,
      agora::rtc::RtcConnection const &connection) override {
    return 0;
  }
  ...
  virtual int
  enableDualStreamModeEx(agora::rtc::VIDEO_SOURCE_TYPE sourceType, bool enabled,
  ...
  virtual int
  setDualStreamModeEx(agora::rtc::VIDEO_SOURCE_TYPE sourceType,
                      agora::rtc::SIMULCAST_STREAM_MODE mode,
                      agora::rtc::SimulcastStreamConfig const &streamConfig,
                      agora::rtc::RtcConnection const &connection) override {
    return 0;
