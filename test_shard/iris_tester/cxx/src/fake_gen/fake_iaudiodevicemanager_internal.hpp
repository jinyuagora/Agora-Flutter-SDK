...
class FakeIAudioDeviceManagerInternal : public agora::rtc::IAudioDeviceManager {
  ...
  virtual int setPlaybackDevice(char const[512] deviceId) override { return 0; }

  virtual int getPlaybackDevice(char[512] deviceId) override { return 0; }

  virtual int getPlaybackDeviceInfo(char[512] deviceId,
                                    char[512] deviceName) override {
    return 0;
  }
  ...
  virtual int setRecordingDevice(char const[512] deviceId) override {
    return 0;
  }

  virtual int getRecordingDevice(char[512] deviceId) override { return 0; }

  virtual int getRecordingDeviceInfo(char[512] deviceId,
                                     char[512] deviceName) override {
    return 0;
  }
